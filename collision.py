...
collision_router[ ('ball', 'ball') ] = collision_ball_ball						#ball/ball collision
collision_router[ ('ball', 'block') ] = collision_ball_block					#ball/block collision
collision_router[ ('ball', 'triangle') ] = collision_ball_block					#ball/triangle collision
collision_router[ ('ball', 'rotatingblock') ] = collision_ball_rotating_block	#ball/rotating block collision	
collision_router[ ('snowman', 'block') ] = collision_ball_block					#snowman/block collision
collision_router[ ('ball', 'snowman') ] = collision_ball_ball					#ball/snowman collision	
collision_router[ ('ball', 'hotchocolate') ] = collision_ball_block				#ball/hotchocolate collision	
									

def collision(ball, thing, dt):
	key = (ball.getType(), thing.getType())
	func = collision_router[key]
	return func(ball, thing, dt)